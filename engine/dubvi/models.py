...
class ErrorCode(str, Enum):
    ...
    YTDLP_UNSUPPORTED_OR_CHANGED_SITE = "UNSUPPORTED_OR_CHANGED_SITE"
    YTDLP_AUTH_REQUIRED = "AUTH_REQUIRED"
    YTDLP_NETWORK = "NETWORK_TIMEOUT"
    YTDLP_FORMAT_UNAVAILABLE = "FORMAT_UNAVAILABLE"
    YTDLP_DOWNLOAD_FAILED = "YTDLP_DOWNLOAD_FAILED"
    INTERNAL = "INTERNAL"
